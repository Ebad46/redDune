...
export const ENGINEERING_PAGE_DATA = [
    {
        ...
        sections: [
            ...
            },
            {
                ...
                description: "Our team is equipped with the latest diagnostic and calibration tools specifically designed for German luxury brands. We don't just clear error codes; we perform physical and software-based alignment to ensure 100% accuracy.",
                image: "/images/engineering.jpg",
                cta: "Reach us now"
            }
        ]
        ...
        sections: [
            {
                ...
                description: "Don't let outdated maps lead you astray. We provide the latest GPS database updates for all major German luxury car brands, ensuring you have the most accurate routes, points of interest, and speed limit information available for the UAE and GCC region.",
