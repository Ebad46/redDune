      ...
      <section className="relative pt-24 md:pt-32 pb-0 overflow-hidden bg-white">
        <div className="container mx-auto max-w-[1200px] px-6">
          <div className="flex flex-col lg:flex-row items-stretch gap-8 lg:gap-0 min-h-[500px] lg:min-h-[600px]">
            ...
            >
              <Image
                src="https://images.ebadprince49.workers.dev/nop 1.jfif"
      ...
      <div className="bg-neutral-50 border-y border-gray-100 py-10">
        <div className="container mx-auto max-w-[1200px] px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-4">
            {[
              { label: t("recovery.trustBar.response"), value: "30-45m", icon: Clock },
              { label: t("recovery.trustBar.availability"), value: "24/7", icon: Shield },
              { label: t("recovery.trustBar.fleet"), value: "25+", icon: Truck },
              { label: t("recovery.trustBar.rating"), value: "4.9/5", icon: Star },
            ].map((stat, i) => (
      ...
      <section className="py-16 md:py-24 bg-white overflow-hidden">
        <div className="container mx-auto max-w-[1200px] px-6">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            >
              <Image
                src="https://images.ebadprince49.workers.dev/ser (2).jpg"
      ...
      <section className="py-16 md:py-24 bg-neutral-50 overflow-hidden">
        <div className="container mx-auto max-w-[1200px] px-6">
          <div className="flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-20">
            ...
            >
              <Image
                src="https://images.ebadprince49.workers.dev/ser (1).jpg"
      ...
      <section className="py-24 bg-white overflow-hidden">
        ...
        <div className="container mx-auto max-w-[1200px] px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { key: "luxury", img: "https://images.ebadprince49.workers.dev/car.jpg" },
              { key: "suv", img: "https://images.ebadprince49.workers.dev/car (2).jpg" },
              { key: "ev", img: "https://images.ebadprince49.workers.dev/car (3).jpg" },
              { key: "commercial", img: "https://images.ebadprince49.workers.dev/car (1).jpg" },
            ].map((item, i) => (
              <div
                key={i}
            ...
            <div className="w-full lg:w-1/3" data-aos="fade-right">
              <div className="sticky top-32">
                ...
                <p className="text-gray-600 mb-8">
                  {t("recovery.faq.subtitle")}
                </p>
                <div className="p-6 bg-white border border-gray-200">
                  <p className="text-xs font-bold uppercase tracking-widest text-primary mb-2">{t("recovery.faq.stillQuestions")}</p>
                  <p className="font-bold text-black uppercase text-sm mb-4">{t("recovery.faq.dispatch")}</p>
