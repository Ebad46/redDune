          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 h-[400px] w-full relative group">
              ...
              <div className="relative z-10 w-full h-full">
                <Image
                  src="https://images.ebadprince49.workers.dev/ins2.jpeg"
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            ...
            <div className="lg:w-1/2 h-[400px] w-full relative group">
              ...
              <div className="relative z-10 w-full h-full">
                <Image
                  src="https://images.ebadprince49.workers.dev/ins3.jpeg"
        ...
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            ...
            <div className="lg:w-1/2 h-[400px] w-full relative group">
              ...
              <div className="relative z-10 w-full h-full">
                <Image
                  src="https://images.ebadprince49.workers.dev/ins4.png"
