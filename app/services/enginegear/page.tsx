          ...
          >
            ...
            <div className="text-gray-700 text-lg space-y-4 leading-relaxed">
              <p>
                ...
                gearbox overhauling is the process of disassembling the
                intricate sections, replacing the parts required with precision
                to restore them to working order, and reassembling them.
              </p>
              <p>
                Our professional team uses the highest quality, best-performing
                products and services available. With the help of skilled
                technicians and the most advanced tools, your gearbox will
                always be in its peak condition.
              </p>
            </div>
            <Link
          ...
          >
            ...
            <div className="text-gray-700 text-lg space-y-4 leading-relaxed">
              ...
              <p>
                ...
                doesn&apos;t go through multiple parts or repair sessions that
                are not required. At our shop, our highly skilled team can
                accurately diagnose transmission and engine issues.
              </p>
            </div>
            <Link
              href="/services/enginegear#contact"
      ...
      <section className="py-20 px-6 lg:px-20 container mx-auto bg-gray-50/50">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="text-gray-700 text-lg space-y-4 leading-relaxed">
              <p>
                There are several advantages to undergoing a transmission
                overhaul rather than a replacement. One of the most important
                factors is that transmission rebuilds are a low-cost alternative
                to transmission replacements. With the cost of a brand-new
          ...
          >
            ...
            <div className="text-gray-700 text-lg space-y-4 leading-relaxed">
              ...
              <p>
                ...
                every part of your vehicle. Don&apos;t think twice; let&apos;s
                fulfill your car with the best repair services!
              </p>
            </div>
            <Link
              href="/services/enginegear#contact"
