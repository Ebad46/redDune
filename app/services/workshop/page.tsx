        ...
        <div className="w-full lg:w-1/2 p-12 lg:p-24 flex flex-col justify-center">
          <div className="bs-text opacity-0">
            ...
            <p className="font-sans text-lg text-muted-foreground leading-relaxed mb-8 font-light">
              Our world-class workshop is equipped with the latest technology to
              handle any automotive challenge. We maintain a pristine, organized
              environment that reflects the quality of work we deliver. Whether
              it&apos;s a minor adjustment or a major overhaul, your car is in
              the safest hands.
            </p>
          </div>
        </div>
