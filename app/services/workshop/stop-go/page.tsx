    ...
    <main className="min-h-screen bg-white text-black font-sans selection:bg-red-600 selection:text-white">
          ...
          <div className="flex flex-col lg:flex-row items-stretch gap-0 min-h-[580px]">
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-[1.7] max-w-xl mb-10">
                Comprehensive inspection, repair, and maintenance package
                designed to keep your car running safely and efficiently on UAE
                roads.
              </p>
            ...
            >
              <div>
                ...
                <p className="text-lg text-gray-600 leading-[1.7]">
                  Vehicles may suddenly stop due to fuel system faults,
                  alternator issues, ignition problems, sensor malfunctions, or
                  other mechanical failures. Regular maintenance prevents
                  unexpected breakdowns and costly repairs. A structured service
                  routine is the most reliable way to protect your investment
                  and ensure safety on UAE roads.
                </p>
              </div>
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            ...
            >
              <div>
                ...
                <div className="w-12 h-[3px] bg-primary mb-6" />
                <p className="text-lg text-gray-600 leading-[1.7]">
                  Our experienced technicians provide complete repair and
                  maintenance services using advanced diagnostic tools and
                  modern equipment to ensure your vehicle remains in peak
                  condition. We take a structured, thorough approach — no
      ...
      <section className="py-[100px] bg-white border-b border-gray-100 overflow-hidden">
        <div className="container mx-auto max-w-[1200px] px-6">
          ...
          >
            <p className="text-lg text-gray-600 leading-[1.7]">
              Everything your car needs in a single service visit. Our Stop
              &amp; Go package eliminates the hassle of multiple appointments —
              one comprehensive session keeps your vehicle fully maintained and
              road-ready.
            </p>
            <Link href="#contact" className="inline-block w-full sm:w-auto">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              <div>
                ...
                <div className="w-12 h-[3px] bg-primary mb-6" />
                <p className="text-lg text-gray-600 leading-[1.7]">
                  With state-of-the-art tools and years of expertise, we ensure
                  your car stays in peak operating condition. Regular servicing
                  extends vehicle lifespan and protects your investment —
                  turning routine maintenance into long-term savings.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {[
                 
                  {
                    ...
                    desc: "Structured maintenance plans at locked-in rates.",
                  },
                 
                  {
                    label: "Original Replacement Parts",
                    desc: "OEM components every time.",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
      ...
      <section className="py-[100px] bg-white border-b border-gray-100 overflow-hidden">
        <div className="container mx-auto max-w-[1200px] px-6 text-center">
          ...
          >
            ...
            <div className="w-12 h-[3px] bg-primary mx-auto" />
            <p className="text-lg text-gray-600 leading-[1.7]">
              Our dedicated mechanics are committed to delivering high-quality
              repair and maintenance services. Every service is designed to
              maximize safety, reliability, and driving comfort. We don&apos;t
              just fix cars — we maintain the standard your vehicle deserves.
            </p>
      ...
      <section className="py-24 bg-black text-white" id="contact">
        <div className="container mx-auto max-w-[1200px] px-6 text-center">
          ...
          >
            Book Your{" "}
            <span className="text-primary">Stop &amp; Go Service</span> Today
          </h2>
          <p
            ...
            data-aos-delay="100"
          >
            One visit. Complete care. Visit Red Dune Experts in Dubai &amp; Abu
            Dhabi for the most thorough and reliable car maintenance package
            available.
          </p>
