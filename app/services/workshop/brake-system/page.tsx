    ...
    <main className="min-h-screen bg-white text-black font-sans selection:bg-red-600 selection:text-white">
          ...
          <div className="flex flex-col lg:flex-row items-stretch gap-0 min-h-[580px]">
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-[1.7] max-w-xl mb-10">
                Complete brake diagnostics, ABS repair, and precision
                maintenance to ensure maximum safety and stopping performance.
              </p>
            ...
            >
              <div>
                ...
                <p className="text-lg text-gray-600 leading-[1.7]">
                  Our certified technicians carry out a full-spectrum brake
                  service to keep your stopping power precise and reliable. We
                  handle everything from routine pad changes to in-depth system
                  overhauls — all using genuine, manufacturer-approved
                  components.
                </p>
              </div>
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            ...
            >
              <div>
                ...
                <div className="w-12 h-[3px] bg-primary mb-6" />
                <p className="text-lg text-gray-600 leading-[1.7]">
                  The ABS is a critical safety system that prevents wheel
                  lock-up during emergency braking. In UAE road conditions —
                  high-speed motorways and sudden stops — a faulty ABS can be
                  dangerous. We diagnose, repair, and recalibrate your system
                  using OEM-level software.
                </p>
              </div>
              ...
              <p className="text-gray-600 leading-[1.7]">
                Never ignore an ABS warning light. In the UAE&apos;s high-speed
                driving environment, a malfunctioning ABS system reduces your
                vehicle&apos;s ability to stop safely in emergencies. Early
                intervention saves money and, more importantly, lives.
              </p>
        ...
        <div className="container mx-auto max-w-[1200px] px-6">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-[1.7]">
                We don&apos;t guess — we diagnose. Every brake service is backed
                by proper equipment and verified results before your vehicle
                leaves our workshop. Your safety is not a service item;
                it&apos;s our standard.
              </p>
      ...
      <section className="py-[100px] bg-gray-50 border-b border-gray-200 overflow-hidden">
        <div className="container mx-auto max-w-[1200px] px-6">
          ...
          >
            <p className="text-lg text-gray-600 leading-[1.7]">
              If you notice any of these symptoms, do not delay. Brake system
              faults deteriorate rapidly, especially in high-temperature
              conditions. Book an inspection immediately — your safety and the
              safety of others on the road depends on it.
            </p>
            <Link href="#contact" className="inline-block w-full sm:w-auto">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              <div>
                ...
                <div className="w-12 h-[3px] bg-primary mb-6" />
                <p className="text-lg text-gray-600 leading-[1.7]">
                  At our workshop, we focus on precision, safety, and long-term
                  reliability. Every brake inspection and repair is performed
                  using professional-grade tools and tested thoroughly before
                  delivery. We do not cut corners where your safety is
                  concerned.
                </p>
              </div>
              ...
              <div className="bg-black text-white p-8 border-l-4 border-primary">
                <p className="text-gray-300 font-light leading-[1.7] italic">
                  &ldquo;A brake system performing at 100% is not a luxury — it
                  is the minimum standard every driver deserves.&rdquo;
                </p>
              </div>
      ...
      <section className="py-24 bg-black text-white" id="contact">
        <div className="container mx-auto max-w-[1200px] px-6 text-center">
          ...
          <p
            ...
            data-aos-delay="100"
          >
            Don&apos;t compromise your safety. Contact our brake specialists
            today for a professional inspection and transparent quote.
          </p>
